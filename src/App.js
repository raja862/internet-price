...
function App() {
  ...
  <h1 className='inter'>Internet Price List</h1>
      ...
      <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <h6 className="card-price text-center">Rs9<span className="period">/month</span></h6>
            ...
            <div className="d-grid">
              <a href="asds" className="btn btn-primary text-uppercase">Button</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <h6 className="card-price text-center">Rs49<span className="period">/month</span></h6>
      ...
      <div className="col-lg-4">
        <div className="card">
          <div className="card-body">
            ...
            <h6 className="card-price text-center">Rs69<span className="period">/month</span></h6>
